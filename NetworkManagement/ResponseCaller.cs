...
namespace CapsBallServer
{
    public static class ResponseCaller
    {
        ...
        public static void ResponseBonusAdded(BonusItemData bonusItemData)
        {
            List<string> parameters = new List<string>(new string[] { JsonSerializer.Serialize(bonusItemData) });
            ResponsePackage package = new ResponsePackage(ResponseCommand.BONUS_ADDED, parameters);
            TeamsHandler.Broadcast(package);
        }

        public static void ResponseBonusAdded(BonusItemData bonusItemData, string receiverNick)
        {
            List<string> parameters = new List<string>(new string[] { JsonSerializer.Serialize(bonusItemData) });
            ResponsePackage package = new ResponsePackage(ResponseCommand.BONUS_ADDED, parameters);
            Sender.SendFeedbackByAlias(package.GetRawData(), receiverNick);
        }
